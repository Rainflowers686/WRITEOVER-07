...
supervisor trying to make the player's improvisation sound like procedure.
People interrupt that procedure with work, fatigue, discretion, and concern.
The first chapter moves from being processed to choosing what gets recorded.
...
Cold slate is architecture and Security. Warm bone is readable edge/text.
Maintenance is worn ochre. Muted sea-green denotes powered interaction and
clinical equipment; amber is attention, red is actual danger. No colour-only
distinctions: visor, coat, cap, `!`, labels and position survive reduced colour.
...
Voice: exact, composed, faintly possessive; a clerk who dislikes unscheduled
events. Usually one or two short sentences. Dry humour through administrative
understatement, never jokes after a death. Calls the player “you”, not “hero”.
Obedience is acknowledged as processing, improvisation as an amendment,
violence as a change that cannot be undone by relabelling it. System manipulation
exposes the gap between an event and its record. The voice can mislead by
framing and omission, but may not assert cameras saw something they did not.
...
addresses the person rather than the badge. No shared generic comedian voice.
...
Use existing procedural cues: dry impulse for pistol, electrical pair for
stunner, brief urgent alert, unambiguous access response, restrained completion.
Leave space after consequential speech. No new audio engine. Music direction
