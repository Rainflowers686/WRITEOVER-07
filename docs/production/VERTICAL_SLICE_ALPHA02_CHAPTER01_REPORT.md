...
FINAL_HEAD = c6b3872611ed3a299cb5e05b9b0569083b88d187 (implementation head; receipt documentation follows)
ORIGIN_MAIN = b7ddb63d0527202d99d0ebaf3085426a2ffed9df (before normal push)
BRANCH = main
PUSHED = PENDING
...
```text
CHARACTER_RENDER_WORKLOAD_240x67 worst_1pct_avg_ms = 1.226
INTEGRATED_TOTAL_FRAME_PROXY_240x67 worst_1pct_avg_ms = 2.009
...
FINAL_STATUS = PENDING_REMOTE_CI_AND_FINAL_RECEIPT
```
