...
$scenarios = @(
    ...
    [pscustomobject]@{ Name="guard_dead_body_hidden"; Classification="CHAPTER_COMPLETABLE"; Disposition="VALID_PLAYER_STATE_NOT_YET_COVERED"; Fixture=""; Frames=0; Room=""; Expected=@() },
    ...
    [pscustomobject]@{ Name="terminal_active_badge_revoked"; Classification="EXPECTED_DENIAL"; Disposition="VALID_PLAYER_STATE_NOT_YET_COVERED"; Fixture=""; Frames=0; Room=""; Expected=@() },
    ...
    [pscustomobject]@{ Name="player_restarted_with_durable_history"; Classification="EXPECTED_RECOVERABLE_FAILURE"; Disposition="VALID_PLAYER_STATE_NOT_YET_COVERED"; Fixture=""; Frames=0; Room=""; Expected=@() },
    ...
    [pscustomobject]@{ Name="wall_blocked_guard_line_of_sight"; Classification="EXPECTED_DENIAL"; Disposition="VALID_PLAYER_STATE_NOT_YET_COVERED"; Fixture=""; Frames=0; Room=""; Expected=@() },
    ...
    [pscustomobject]@{ Name="elevator_entry_without_route_fact"; Classification="EXPECTED_DENIAL"; Disposition="VALID_PLAYER_STATE_NOT_YET_COVERED"; Fixture=""; Frames=0; Room=""; Expected=@() },
